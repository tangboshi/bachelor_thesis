#!/bin/bash
#********************************* Options ************************************
THIS_PATH=/home/inets/source/gr-inets
LOCATE_BASE_PATH=$THIS_PATH/examples/Tests
...
export RAW_DATA_SOURCE_PATH=$THIS_PATH/results
...
MEASUREMENT_SCRIPTS=( two_way_handshake_test_Rx.py two_way_handshake_test_Tx.py )
